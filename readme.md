...
**Answer**
Spread operator creates a new array from a old array. If we change anything in new array the old array will be still same.
we can also merge data from 2 array into 1 array.
...
**Answer**
Template literals allowes us to to do string interpolation using the ${expression} syntax and its support multiline string.